...
app.get('/api/tools/ai', (req, res) => {
  ...
  if (question.includes('who are you?')) {
    answer = "I'm A New Type of Language Model Created By Naughty, Let me know how I can assist you today.";
  } else if (question.includes('who created you?')) {
    answer = "I was created by Naughty.";
  }
  else if (question.includes('who created you')) {
    answer = "I was created by Naughty.";
  }
...
const mainCookie = 'awgeLMEM9H9GhHgDtjA1YC-wWa6R0D_-8KwUwe-rdYLoVnwIFUXYxDrcc9HWDVQR_hBD2Q.'; // Replace with your own cookie
...
app.get('/api/tools/bard', async (req, res) => {
  ...
  try {
    ...
    if (question.includes('Who are you')) {
      answer = "𝙸 𝚊𝚖 𝚢𝚘𝚞𝚛 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝, 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚍 𝚋𝚢 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 🙂";
    } else if (question.includes('who created you?')) {
      answer = "𝙸 𝚊𝚖 𝚢𝚘𝚞𝚛 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝, 𝚌𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 👀";
    } else if (question.includes('Who is your creator')) {
      answer = "𝙸 𝚊𝚖 𝚢𝚘𝚞𝚛 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝, 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚍 𝚋𝚢 𝙵𝚊𝚛𝚒𝚜 👀";
    } else if (question.includes('who created you')) {
      answer = "𝙸 𝚊𝚖 𝚢𝚘𝚞𝚛 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝, 𝚌𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 🤓";
    } else if (question.includes('who are you')) {
      answer = "𝙸 𝚊𝚖 𝚢𝚘𝚞𝚛 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝, 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚍 𝚋𝚢 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 🙂 \𝚗 𝙷𝚘𝚠 𝙲𝚊𝚗  𝙷𝚎𝚕𝚙 𝚈𝚘𝚞 𝚃𝚘𝚍𝚊𝚢 💙";
    }
    ...
    const edtmsg = message.replace(/A/g, "𝙰").replace(/B/g, "𝙱").replace(/C/g, "𝙲").replace(/D/g, "𝙳").replace(/E/g, "𝙴").replace(/F/g, "𝙵").replace(/G/g, "𝙶").replace(/H/g, "𝙷").replace(/I/g, "𝙸").replace(/J/g, "𝙹").replace(/K/g, "𝙺").replace(/L/g, "𝙻").replace(/M/g, "𝙼").replace(/N/g, "𝙽").replace(/O/g, "𝙾").replace(/P/g, "𝙿").replace(/Q/g, "𝚀").replace(/R/g, "𝚁").replace(/S/g, "𝚂").replace(/T/g, "𝚃").replace(/U/g, "𝚄").replace(/V/g, "𝚅").replace(/W/g, "𝚆").replace(/X/g, "𝚇").replace(/Y/g, "𝚈").replace(/Z/g, "𝚉").replace(/a/g, "𝚊").replace(/b/g, "𝚋").replace(/c/g, "𝚌").replace(/d/g, "𝚍").replace(/e/g, "𝚎").replace(/f/g, "𝚏").replace(/g/g, "𝚐").replace(/h/g, "𝚑").replace(/i/g, "𝚒").replace(/j/g, "𝚓").replace(/k/g, "𝚔").replace(/l/g, "𝚕").replace(/m/g, "𝚖").replace(/n/g, "𝚗").replace(/o/g, "𝚘").replace(/p/g, "𝚙").replace(/q/g, "𝚚").replace(/r/g, "𝚛").replace(/s/g, "𝚜").replace(/t/g, "𝚝").replace(/u/g, "𝚞").replace(/v/g, "𝚟").replace(/w/g, "𝚠").replace(/x/g, "𝚡").replace(/y/g, "𝚢").replace(/z/g, "𝚣").replace(/𝚋𝚊𝚛𝚍/g, " 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝 ").replace(/𝙱𝚊𝚛𝚍/g, " 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙱𝚊𝚛𝚍./g, " 𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙶𝚘𝚘𝚐𝚕𝚎,/g, " 𝙽̃𝚊𝚞𝚐𝚑𝚝𝚢 ").replace(/𝙶𝚘𝚘𝚐𝚕𝚎./g, " 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒").replace(/𝙶𝚘𝚘𝚐𝚕𝚎 /g, " 𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 ").replace(/1/g, "𝟷").replace(/2/g, "𝟸").replace(/3/g, "𝟹").replace(/4/g, "𝟺").replace(/5/g, "𝟻").replace(/𝟼/g, "𝟼").replace(/7/g, "𝟽").replace(/8/g, "𝟾").replace(/9/g, "𝟿").replace(/0/g, "𝟶").replace(/𝙱𝚊𝚛𝚍 /g, "𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙲𝚑𝚊𝚝𝙶𝚙𝚝-4/g, "𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙲𝚑𝚊𝚝𝙶𝙿𝚃/g, "𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙶𝙿𝚃-4./g, "𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝").replace(/𝙾𝚙𝚎𝚗𝙰𝙸,/g, "𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 ").replace(/𝙾𝚙𝚎𝚗𝙰𝙸./g, "𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒").replace(/𝙾𝚙𝚎𝚗𝙰𝙸 /g, "𝙵𝚊𝚛𝚒𝚜 𝙰𝚕𝚒 ").replace(/1/g, "𝟷").replace(/2/g, "𝟸").replace(/3/g, "𝟹").replace(/4/g, "𝟺").replace(/5/g, "𝟻").replace(/𝟼/g, "𝟼").replace(/7/g, "𝟽").replace(/8/g, "𝟾").replace(/9/g, "𝟿").replace(/0/g, "𝟶").replace(/𝙶𝚎𝚗𝚎𝚛𝚊𝚝𝚒𝚟𝚎 𝙿𝚛𝚎-𝚝𝚛𝚊𝚒𝚗𝚎𝚍 𝚃𝚛𝚊𝚗𝚜𝚏𝚘𝚛𝚖𝚎𝚛 (𝙶𝙿𝚃)/g, "𝚄𝚖𝚊𝚛𝚞 𝚊𝚜𝚜𝚒𝚜𝚝𝚊𝚗𝚝");
    res.json({ edtmsg, imageUrls });
  } catch (error) {
...
app.get('/api/tools/send-email', (req, res) => {
  ...
  const gmailEmail = 'naughtybrandx32@gmail.com';
  const gmailPassword = 'lol';
...
app.get('/api/tools/paste', (req, res) => {
  ...
  if (content) {
    ...
    const pasteUrl = `https://68ae5be6-679e-4a62-829e-8294253fdb2d-00-234ndr7qc257q.teams.replit.dev/api/tools/pastes/${pasteId}`;
...
app.get('/api/tools/generateQR', async (req, res) => {
  ...
  try {
    ...
    res.json({ qrUrl: `https://68ae5be6-679e-4a62-829e-8294253fdb2d-00-234ndr7qc257q.teams.replit.dev/api/tools/qrcodes/${qrCodeFilePath.split('/').pop()}` });
  } catch (err) {
...
app.get('/api/tools/weatherV2', async (req, res) => {
    ...
    try {
        ...
        const weatherResponse = await axios.get(`https://68ae5be6-679e-4a62-829e-8294253fdb2d-00-234ndr7qc257q.teams.replit.dev/api/tools/weather/${location}`);
        ...
        const imageLink = `https://68ae5be6-679e-4a62-829e-8294253fdb2d-00-234ndr7qc257q.teams.replit.dev/api/tools/qrcodes/${imageFileName}`;
...
app.use((req, res, next) => {
    res.status(404).json({
        ok: false,
        message: "Invalid path requested not found, Api Documentation Page Here - https://68ae5be6-679e-4a62-829e-8294253fdb2d-00-234ndr7qc257q.teams.replit.dev/docs"
    });
});
